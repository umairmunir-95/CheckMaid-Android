...
public class DamageReportsActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DamageReportsActivity.this, PropertiesActivity.class);
                startActivity(i);
            }
        });
        ...
        etChooseDate.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP) {
                    datePicker.showDatePickerDialog(DamageReportsActivity.this,false, etChooseDate, App.CALENDER_DATE_FORMAT, null,null,null);
                    return true;
                }
                return false;
            }
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(NetworkManager.isNetworkAvailable(DamageReportsActivity.this)) {
                    if(!etChooseDate.getText().toString().equals("") && ! etProperties.getText().toString().equals("")) {
                        String url = App.LIST_ALL_DAMAGE_REPORTS + "/" + App.BY_DATE + "/" + etChooseDate.getText().toString().trim();
                        damageReportsViewModel.getDamageReports(DamageReportsActivity.this, progressBar, url);
                    }
                }
                else
                {
                    DialogManager.showInfoDialog(DamageReportsActivity.this,"",getResources().getString(R.string.internet_available_msg),false);
                }
            }
        });
    }
    ...
    private void showPropertiesListPopUp()
    {
        ...
        lvProperties.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                AppStore.DAMAGE_REPORTS_PROPERTY_NAME=etProperties.getText().toString().trim();
                alertDialog.cancel();
            }
        });
        ...
        String[] assignedProperties= Helpers.getPreferenceValue(DamageReportsActivity.this,getResources().getString(R.string.all_properties)).split(",");
        if(assignedProperties.length==0) {
            DialogManager.showInfoDialog(DamageReportsActivity.this, "", getResources().getString(R.string.no_property_assignment), false);
        }
        else{
        ...
        ListViewSearchUsersAdapter adapter=new ListViewSearchUsersAdapter(DamageReportsActivity.this,users);
